...
__weak_func error_tc ccmEncrypt(const CipherAlgo *cipher, void *context, const uint8_t *n,
...
__weak_func error_tc ccmDecrypt(const CipherAlgo *cipher, void *context, const uint8_t *n,
...
error_tc ccmFormatBlock0(size_t q, const uint8_t *n, size_t nLen, size_t aLen,
