...
__weak_func error_tc gcmInit(GcmContext *context, const CipherAlgo *cipherAlgo,
   void *cipherContext)
{
   uint_t i;
   uint_t j;
...
__weak_func error_tc gcmEncrypt(GcmContext *context, const uint8_t *iv,
...
__weak_func error_tc gcmDecrypt(GcmContext *context, const uint8_t *iv,
