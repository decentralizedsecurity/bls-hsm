...
error_tc blowfishInit(BlowfishContext *context, const uint8_t *key,
   size_t keyLen)
{
   error_tc error;
...
error_tc blowfishInitState(BlowfishContext *context)
{
   uint_t i;
...
error_tc blowfishExpandKey(BlowfishContext *context, const uint8_t *salt,
