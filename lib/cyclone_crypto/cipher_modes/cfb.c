...
__weak_func error_tc cfbEncrypt(const CipherAlgo *cipher, void *context, uint_t s,
...
__weak_func error_tc cfbDecrypt(const CipherAlgo *cipher, void *context, uint_t s,
