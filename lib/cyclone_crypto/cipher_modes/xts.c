...
error_tc xtsInit(XtsContext *context, const CipherAlgo *cipherAlgo,
...
error_tc xtsEncrypt(XtsContext *context, const uint8_t *i, const uint8_t *p,
...
error_tc xtsDecrypt(XtsContext *context, const uint8_t *i, const uint8_t *c,
