...
__weak_func error_tc ecGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
__weak_func error_tc ecAffinify(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   error_tc error;
   Mpi a;
...
__weak_func error_tc ecMult(const EcDomainParameters *params, EcPoint *r, const Mpi *d,
   const EcPoint *s)
{
   error_tc error;
   uint_t i;
...
__weak_func error_tc ecTwinMult(const EcDomainParameters *params, EcPoint *r,
...
__weak_func error_tc ecAddMod(const EcDomainParameters *params, Mpi *r,
...
__weak_func error_tc ecSubMod(const EcDomainParameters *params, Mpi *r,
   const Mpi *a, const Mpi *b)
{
   error_tc error;
...
__weak_func error_tc ecMulMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   error_tc error;
...
__weak_func error_tc ecSqrMod(const EcDomainParameters *params, Mpi *r, const Mpi *a)
{
   error_tc error;
