...
typedef error_tc (*EcFastModAlgo)(Mpi *a, const Mpi *p);
...
error_tc secp128r1Mod(Mpi *a, const Mpi *p);
error_tc secp128r2Mod(Mpi *a, const Mpi *p);
error_tc secp160k1Mod(Mpi *a, const Mpi *p);
error_tc secp160r1Mod(Mpi *a, const Mpi *p);
error_tc secp160r2Mod(Mpi *a, const Mpi *p);
error_tc secp192k1Mod(Mpi *a, const Mpi *p);
error_tc secp192r1Mod(Mpi *a, const Mpi *p);
error_tc secp224k1Mod(Mpi *a, const Mpi *p);
error_tc secp224r1Mod(Mpi *a, const Mpi *p);
error_tc secp256k1Mod(Mpi *a, const Mpi *p);
error_tc secp256r1Mod(Mpi *a, const Mpi *p);
error_tc secp384r1Mod(Mpi *a, const Mpi *p);
error_tc secp521r1Mod(Mpi *a, const Mpi *p);
error_tc brainpoolP160r1Mod(Mpi *a, const Mpi *p);
error_tc brainpoolP192r1Mod(Mpi *a, const Mpi *p);
error_tc brainpoolP224r1Mod(Mpi *a, const Mpi *p);
error_tc brainpoolP256r1Mod(Mpi *a, const Mpi *p);
error_tc brainpoolP320r1Mod(Mpi *a, const Mpi *p);
error_tc brainpoolP384r1Mod(Mpi *a, const Mpi *p);
error_tc brainpoolP512r1Mod(Mpi *a, const Mpi *p);
error_tc frp256v1Mod(Mpi *a, const Mpi *p);
error_tc sm2Mod(Mpi *a, const Mpi *p);
