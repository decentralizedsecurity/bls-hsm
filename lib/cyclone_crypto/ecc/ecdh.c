...
error_tc ecdhGenerateKeyPair(EcdhContext *context, const PrngAlgo *prngAlgo,
   void *prngContext)
{
   error_tc error;
...
error_tc ecdhCheckPublicKey(const EcDomainParameters *params, EcPoint *publicKey)
{
   bool_t valid;
...
error_tc ecdhComputeSharedSecret(EcdhContext *context,
