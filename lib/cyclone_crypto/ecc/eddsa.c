...
error_tc eddsaGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc eddsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
   const EcCurveInfo *curveInfo, EddsaPrivateKey *privateKey)
{
   error_tc error;
...
error_tc eddsaGeneratePublicKey(const EcCurveInfo *curveInfo,
