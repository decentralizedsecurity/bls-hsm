...
error_tc sm2GenerateSignature(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc sm2VerifySignature(const EcDomainParameters *params,
...
error_tc sm2ComputeZa(const HashAlgo *hashAlgo, HashContext *hashContext,
