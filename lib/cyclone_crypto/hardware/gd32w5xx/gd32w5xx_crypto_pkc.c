...
error_tc pkcauExportMpi(Mpi *r, uint_t length, uint_t offset)
{
   error_tc error;
   uint_t i;
...
error_tc pkcauModExp(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   error_tc error;
   uint_t modLen;
   uint_t expLen;
...
error_tc pkcauRsaCrtExp(const RsaPrivateKey *key, const Mpi *c, Mpi *m)
{
   error_tc error;
   uint_t nLen;
   uint_t pLen;
...
error_tc ecdsaVerifySignature(const EcDomainParameters *params,
