...
error_tc mpiMod2(Mpi *r, const Mpi *a, const Mpi *p)
{
   error_tc error;
   size_t n;
   size_t modLen;
...
error_tc ecAffinify(const EcDomainParameters *ecParams, EcPoint *r,
   const EcPoint *s)
{
   error_tc error;
   size_t modLen;
...
error_tc ecMult(const EcDomainParameters *ecParams, EcPoint *r, const Mpi *d,
   const EcPoint *s)
{
   error_tc error;
   size_t kLen;
...
error_tc ecdsaGenerateSignature(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc ecdsaVerifySignature(const EcDomainParameters *ecParams,
