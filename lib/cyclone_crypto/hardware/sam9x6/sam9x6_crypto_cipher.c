...
error_tc desInit(DesContext *context, const uint8_t *key, size_t keyLen)
{
   //Check parameters
...
error_tc des3Init(Des3Context *context, const uint8_t *key, size_t keyLen)
{
   //Check parameters
   if(context == NULL || key == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_tc xteaInit(XteaContext *context, const uint8_t *key, size_t keyLen)
{
   //Check parameters
   if(context == NULL || key == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_tc aesInit(AesContext *context, const uint8_t *key, size_t keyLen)
{
   //Check parameters
   if(context == NULL || key == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_tc ecbEncrypt(const CipherAlgo *cipher, void *context,
...
error_tc ecbDecrypt(const CipherAlgo *cipher, void *context,
...
error_tc cbcEncrypt(const CipherAlgo *cipher, void *context,
...
error_tc cbcDecrypt(const CipherAlgo *cipher, void *context,
...
error_tc cfbEncrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *p, uint8_t *c, size_t length)
{
   error_tc error;
...
error_tc cfbDecrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *c, uint8_t *p, size_t length)
{
   error_tc error;
...
error_tc ofbEncrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *p, uint8_t *c, size_t length)
{
   error_tc error;
...
error_tc gcmInit(GcmContext *context, const CipherAlgo *cipherAlgo,
   void *cipherContext)
{
   //Check parameters
...
error_tc gcmEncrypt(GcmContext *context, const uint8_t *iv,
...
error_tc gcmDecrypt(GcmContext *context, const uint8_t *iv,
