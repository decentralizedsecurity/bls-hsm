...
error_tc sha1Compute(const void *data, size_t length, uint8_t *digest)
{
   size_t n;
   uint32_t *p;
   uint8_t buffer[64];
...
error_tc sha224Compute(const void *data, size_t length, uint8_t *digest)
{
   size_t n;
   uint32_t *p;
   uint8_t buffer[64];
...
error_tc sha256Compute(const void *data, size_t length, uint8_t *digest)
{
   size_t n;
   uint32_t *p;
   uint8_t buffer[64];
...
error_tc sha384Compute(const void *data, size_t length, uint8_t *digest)
{
   size_t n;
   uint32_t *p;
   uint8_t buffer[128];
...
error_tc sha512Compute(const void *data, size_t length, uint8_t *digest)
{
   size_t n;
   uint32_t *p;
   uint8_t buffer[128];
