...
error_tc ctrEncrypt(const CipherAlgo *cipher, void *context, uint_t m,
...
error_tc ccmEncrypt(const CipherAlgo *cipher, void *context, const uint8_t *n,
...
error_tc ccmDecrypt(const CipherAlgo *cipher, void *context, const uint8_t *n,
