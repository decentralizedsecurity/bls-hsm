...
error_tc pkaExportMpi(Mpi *r, uint_t length, uint_t offset)
{
   error_tc error;
   uint_t i;
...
error_tc pkaModExp(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   error_tc error;
   uint_t modLen;
   uint_t expLen;
...
error_tc pkaRsaCrtExp(const RsaPrivateKey *key, const Mpi *c, Mpi *m)
{
   error_tc error;
   uint_t nLen;
   uint_t pLen;
