...
error_tc bcryptHashPassword(const PrngAlgo *prngAlgo, void *prngContext,
   uint_t cost, const char_t *password, char_t *hash, size_t *hashLen);

error_tc bcryptVerifyPassword(const char_t *password, const char_t *hash);

error_tc bcrypt(uint_t cost, const uint8_t *salt, const char_t *password,
   char_t *hash, size_t *hashLen);

error_tc eksBlowfishSetup(BlowfishContext *context, uint_t cost,
