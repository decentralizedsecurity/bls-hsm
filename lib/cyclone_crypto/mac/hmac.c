...
__weak_func error_tc hmacCompute(const HashAlgo *hash, const void *key, size_t keyLen,
...
__weak_func error_tc hmacInit(HmacContext *context, const HashAlgo *hash,
