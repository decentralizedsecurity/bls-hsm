...
error_tc kmacCompute(uint_t strength, const void *key, size_t keyLen,
...
error_tc kmacInit(KmacContext *context, uint_t strength, const void *key,
...
error_tc kmacFinal(KmacContext *context, uint8_t *mac, size_t macLen)
{
   size_t n;
   uint8_t buffer[sizeof(size_t) + 1];
