...
error_tc xcbcMacCompute(const CipherAlgo *cipher, const void *key, size_t keyLen,
...
error_tc xcbcMacInit(XcbcMacContext *context, const CipherAlgo *cipher,
...
error_tc xcbcMacFinal(XcbcMacContext *context, uint8_t *mac, size_t macLen)
{
