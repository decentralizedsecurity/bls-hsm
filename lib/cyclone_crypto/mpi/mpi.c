...
error_tc mpiGrow(Mpi *r, uint_t size)
{
   error_tc error;
#if (CRYPTO_STATIC_MEM_SUPPORT == DISABLED)
   uint_t *data;
...
error_tc mpiSetBitValue(Mpi *r, uint_t index, uint_t value)
{
   error_tc error;
   uint_t n1;
   uint_t n2;
...
error_tc mpiCopy(Mpi *r, const Mpi *a)
{
   error_tc error;
   uint_t n;
...
error_tc mpiSetValue(Mpi *r, int_t a)
{
   error_tc error;
...
error_tc mpiRand(Mpi *r, uint_t length, const PrngAlgo *prngAlgo,
   void *prngContext)
{
   error_tc error;
   uint_t m;
...
error_tc mpiRandRange(Mpi *r, const Mpi *p, const PrngAlgo *prngAlgo,
   void *prngContext)
{
   error_tc error;
   uint_t n;
...
__weak_func error_tc mpiCheckProbablePrime(const Mpi *a)
{
...
error_tc mpiImport(Mpi *r, const uint8_t *data, uint_t length, MpiFormat format)
{
   error_tc error;
   uint_t i;
...
error_tc mpiExport(const Mpi *a, uint8_t *data, uint_t length, MpiFormat format)
{
   uint_t i;
   uint_t n;
   error_tc error;
...
error_tc mpiAdd(Mpi *r, const Mpi *a, const Mpi *b)
{
   error_tc error;
   int_t sign;
...
error_tc mpiAddInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
error_tc mpiSub(Mpi *r, const Mpi *a, const Mpi *b)
{
   error_tc error;
   int_t sign;
...
error_tc mpiSubInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
error_tc mpiAddAbs(Mpi *r, const Mpi *a, const Mpi *b)
{
   error_tc error;
   uint_t i;
   uint_t n;
...
error_tc mpiSubAbs(Mpi *r, const Mpi *a, const Mpi *b)
{
   error_tc error;
   uint_t c;
   uint_t d;
...
error_tc mpiShiftLeft(Mpi *r, uint_t n)
{
   error_tc error;
   uint_t i;
   uint_t k;
...
error_tc mpiShiftRight(Mpi *r, uint_t n)
{
   uint_t i;
   uint_t m;
...
__weak_func error_tc mpiMul(Mpi *r, const Mpi *a, const Mpi *b)
{
   error_tc error;
   int_t i;
   int_t m;
...
error_tc mpiMulInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
error_tc mpiDiv(Mpi *q, Mpi *r, const Mpi *a, const Mpi *b)
{
   error_tc error;
   uint_t m;
   uint_t n;
...
error_tc mpiDivInt(Mpi *q, Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
error_tc mpiMod(Mpi *r, const Mpi *a, const Mpi *p)
{
   error_tc error;
   int_t sign;
   uint_t m;
...
error_tc mpiAddMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   error_tc error;
...
error_tc mpiSubMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   error_tc error;
...
__weak_func error_tc mpiMulMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   error_tc error;
...
__weak_func error_tc mpiInvMod(Mpi *r, const Mpi *a, const Mpi *p)
{
   error_tc error;
   Mpi b;
   Mpi c;
...
__weak_func error_tc mpiExpMod(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   error_tc error;
   int_t i;
   int_t j;
...
__weak_func error_tc mpiExpModFast(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
...
__weak_func error_tc mpiExpModRegular(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   //Perform modular exponentiation
   return mpiExpMod(r, a, e, p);
}
...
error_tc mpiMontgomeryMul(Mpi *r, const Mpi *a, const Mpi *b, uint_t k,
   const Mpi *p, Mpi *t)
{
   error_tc error;
   uint_t i;
...
error_tc mpiMontgomeryRed(Mpi *r, const Mpi *a, uint_t k, const Mpi *p, Mpi *t)
{
   uint_t value;
   Mpi b;
