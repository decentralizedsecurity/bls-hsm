...
error_tc ocspFormatRequest(const OcspRequest *request, uint8_t *output,
   size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc ocspFormatTbsRequest(const OcspTbsRequest *tbsRequest, uint8_t *output,
   size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc ocspFormatVersion(OcspVersion version, uint8_t *output,
   size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc ocspFormatRequestList(const OcspSingleRequest *requestList,
...
error_tc ocspFormatSingleRequest(const OcspSingleRequest *singleRequest,
...
error_tc ocspFormatCertId(const OcspCertId *certId, uint8_t *output,
   size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc ocspFormatHashAlgo(const OcspCertId *certId, uint8_t *output,
   size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc ocspFormatRequestExtensions(const OcspExtensions *extensions,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc ocspFormatNonceExtension(const X509OctetString *nonce, uint8_t *output,
   size_t *written)
{
   error_tc error;
   size_t n;
