...
error_tc dhGenerateKeyPair(DhContext *context, const PrngAlgo *prngAlgo,
   void *prngContext)
{
   error_tc error;
   uint_t k;
...
error_tc dhCheckPublicKey(DhParameters *params, const Mpi *publicKey)
{
   error_tc error;
   Mpi a;
...
error_tc dhComputeSharedSecret(DhContext *context, uint8_t *output,
