...
error_tc rsaesPkcs1v15Encrypt(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc rsaesPkcs1v15Decrypt(const RsaPrivateKey *key,
   ...
   size_t messageSize, size_t *messageLen)
{
   ...
   do
   {
      ...
      *messageLen = CRYPTO_SELECT_32(n, messageSize, badLength);
      ...
      error = (error_tc) CRYPTO_SELECT_32(error, ERROR_BUFFER_OVERFLOW, badLength);
      error = (error_tc) CRYPTO_SELECT_32(error, ERROR_DECRYPTION_FAILED, badPadding);
...
error_tc rsaesOaepEncrypt(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc rsaesOaepDecrypt(const RsaPrivateKey *key, const HashAlgo *hash,
...
error_tc rsassaPkcs1v15Sign(const RsaPrivateKey *key, const HashAlgo *hash,
...
error_tc rsassaPkcs1v15Verify(const RsaPublicKey *key, const HashAlgo *hash,
...
error_tc rsassaPssSign(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc rsassaPssVerify(const RsaPublicKey *key, const HashAlgo *hash,
...
__weak_func error_tc rsaep(const RsaPublicKey *key, const Mpi *m, Mpi *c)
{
...
__weak_func error_tc rsadp(const RsaPrivateKey *key, const Mpi *c, Mpi *m)
{
   error_tc error;
   Mpi m1;
   Mpi m2;
...
error_tc rsasp1(const RsaPrivateKey *key, const Mpi *m, Mpi *s)
{
...
error_tc rsavp1(const RsaPublicKey *key, const Mpi *s, Mpi *m)
{
...
error_tc emePkcs1v15Encode(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc emeOaepEncode(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc emsaPkcs1v15Encode(const HashAlgo *hash,
...
error_tc emsaPkcs1v15Verify(const HashAlgo *hash, const uint8_t *digest,
...
error_tc emsaPssEncode(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc emsaPssVerify(const HashAlgo *hash, size_t saltLen,
...
error_tc rsaGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
__weak_func error_tc rsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc rsaGeneratePublicKey(const RsaPrivateKey *privateKey,
   RsaPublicKey *publicKey)
{
   error_tc error;
