...
error_tc rsaep(const RsaPublicKey *key, const Mpi *m, Mpi *c);
error_tc rsadp(const RsaPrivateKey *key, const Mpi *c, Mpi *m);
...
error_tc rsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
