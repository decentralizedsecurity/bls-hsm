...
error_tc pemDecodeFile(const char_t *input, size_t inputLen, const char_t *label,
...
error_tc pemEncodeFile(const void *input, size_t inputLen, const char_t *label,
...
error_tc pemParseHeader(const char_t *input, size_t inputLen,
