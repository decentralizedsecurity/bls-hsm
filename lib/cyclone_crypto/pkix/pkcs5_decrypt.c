...
error_tc pkcs5Decrypt(const X509AlgoId *encryptionAlgoId,
...
error_tc pkcs5DecryptPbes1(const X509AlgoId *encryptionAlgoId,
   const char_t *password, const uint8_t *ciphertext, size_t ciphertextLen,
   uint8_t *plaintext, size_t *plaintextLen)
{
   error_tc error;
...
error_tc pkcs5DecryptPbes2(const X509AlgoId *encryptionAlgoId,
   const char_t *password, const uint8_t *ciphertext, size_t ciphertextLen,
   uint8_t *plaintext, size_t *plaintextLen)
{
   error_tc error;
...
error_tc pkcs5ParsePbes1Params(const uint8_t *data, size_t length,
   Pkcs5Pbes1Params *pbes1Params)
{
   error_tc error;
   int32_t value;
...
error_tc pkcs5ParsePbes2Params(const uint8_t *data, size_t length,
   Pkcs5Pbes2Params *pbes2Params)
{
   error_tc error;
   size_t n;
...
error_tc pkcs5ParseKeyDerivationFunc(const uint8_t *data, size_t length,
...
error_tc pkcs5ParsePbkdf2Params(const uint8_t *data, size_t length,
...
error_tc pkcs5ParseEncryptionScheme(const uint8_t *data, size_t length,
