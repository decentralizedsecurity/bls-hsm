...
error_tc pkcs8ParsePrivateKeyInfo(const uint8_t *data, size_t length,
...
error_tc pkcs8ParsePrivateKeyAlgo(const uint8_t *data, size_t length,
...
error_tc pkcs8ParseRsaPrivateKey(const uint8_t *data, size_t length,
...
error_tc pkcs8ParseDsaPrivateKey(const uint8_t *data, size_t length,
...
error_tc pkcs8ParseEcPrivateKey(const uint8_t *data, size_t length,
...
error_tc pkcs8ParseEddsaPrivateKey(const uint8_t *data, size_t length,
...
error_tc pkcs8ParseEncryptedPrivateKeyInfo(const uint8_t *data, size_t length,
...
error_tc pkcs8ParseEncryptionAlgoId(const uint8_t *data, size_t length,
...
error_tc pkcs8ImportRsaPrivateKey(const Pkcs8PrivateKeyInfo *privateKeyInfo,
...
error_tc pkcs8ImportDsaPrivateKey(const Pkcs8PrivateKeyInfo *privateKeyInfo,
...
error_tc pkcs8ImportEcPrivateKey(const Pkcs8PrivateKeyInfo *privateKeyInfo,
...
error_tc pkcs8ImportEddsaPrivateKey(const Pkcs8PrivateKeyInfo *privateKeyInfo,
