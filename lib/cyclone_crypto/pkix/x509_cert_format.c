...
error_tc x509FormatTbsCertificate(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc x509FormatVersion(X509Version version, uint8_t *output,
   size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509FormatSerialNumber(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc x509FormatName(const X509Name *name, uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
   size_t length;
...
error_tc x509FormatNameAttribute(const X509NameAttribute *nameAttribute,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509FormatValidity(const X509Validity *validity, uint8_t *output,
   size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509FormatTime(const DateTime *dateTime, uint8_t *output,
   size_t *written)
{
   error_tc error;
   uint_t type;
