...
error_tc x509ParseCrlExtensions(const uint8_t *data, size_t length,
...
error_tc x509ParseCrlNumber(bool_t critical, const uint8_t *data,
...
error_tc x509ParseDeltaCrlIndicator(bool_t critical, const uint8_t *data,
...
error_tc x509ParseIssuingDistrPoint(bool_t critical, const uint8_t *data,
...
error_tc x509ParseCrlEntryExtensions(const uint8_t *data, size_t length,
...
error_tc x509ParseReasonCode(bool_t critical, const uint8_t *data,
...
error_tc x509ParseInvalidityDate(bool_t critical, const uint8_t *data,
...
error_tc x509ParseCertificateIssuer(bool_t critical, const uint8_t *data,
...
__weak_func error_tc x509ParseUnknownCrlExtension(const uint8_t *oid,
