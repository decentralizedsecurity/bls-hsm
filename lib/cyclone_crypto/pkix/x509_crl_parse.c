...
error_tc x509ParseCrl(const uint8_t *data, size_t length,
   X509CrlInfo *crlInfo)
{
   error_tc error;
   size_t n;
...
error_tc x509ParseTbsCertList(const uint8_t *data, size_t length,
...
error_tc x509ParseCrlVersion(const uint8_t *data, size_t length,
...
error_tc x509ParseRevokedCertificates(const uint8_t *data, size_t length,
   size_t *totalLength, X509TbsCertList *tbsCertList)
{
   error_tc error;
   size_t n;
...
error_tc x509ParseRevokedCertificate(const uint8_t *data, size_t length,
