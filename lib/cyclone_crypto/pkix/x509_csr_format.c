...
error_tc x509FormatCertRequestInfo(const X509CertRequestInfo *certReqInfo,
...
error_tc x509FormatAttributes(const X509Attributes *attributes,
...
error_tc x509FormatChallengePassword(const X509ChallengePassword *challengePwd,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509FormatExtensionRequest(const X509Extensions *extensionReq,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
