...
error_tc x509ParseCsr(const uint8_t *data, size_t length,
   X509CsrInfo *csrInfo)
{
   error_tc error;
   size_t totalLength;
...
error_tc x509ParseCertRequestInfo(const uint8_t *data, size_t length,
...
error_tc x509ParseAttributes(const uint8_t *data, size_t length,
...
error_tc x509ParseAttribute(const uint8_t *data, size_t length,
...
error_tc x509ParseChallengePassword(const uint8_t *data, size_t length,
...
error_tc x509ParseExtensionRequest(const uint8_t *data, size_t length,
