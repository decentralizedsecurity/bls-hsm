...
error_tc x509FormatSubjectPublicKeyInfo(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
error_tc x509FormatAlgoId(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
error_tc x509FormatRsaPublicKey(const X509RsaPublicKey *rsaPublicKey,
...
error_tc x509FormatDsaPublicKey(const X509DsaPublicKey *dsaPublicKey,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509FormatDsaParameters(const X509DsaParameters *dsaParams,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509FormatEcPublicKey(const X509EcPublicKey *ecPublicKey,
   uint8_t *output, size_t *written)
{
...
error_tc x509FormatEcParameters(const X509EcParameters *ecParams,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509ExportRsaPublicKey(const RsaPublicKey *publicKey,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509ExportRsaPrivateKey(const RsaPrivateKey *privateKey,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509ExportDsaPublicKey(const DsaPublicKey *publicKey,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509ExportDsaPrivateKey(const DsaPrivateKey *privateKey,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509ExportDsaParameters(const DsaDomainParameters *params,
   uint8_t *output, size_t *written)
{
   error_tc error;
   size_t n;
...
error_tc x509ExportEcPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
error_tc x509ExportEddsaPublicKey(const EddsaPublicKey *publicKey,
...
error_tc x509ExportEddsaPrivateKey(const EddsaPrivateKey *privateKey,
