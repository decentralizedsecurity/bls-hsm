...
error_tc x509ParseSubjectPublicKeyInfo(const uint8_t *data, size_t length,
...
error_tc x509ParseAlgoId(const uint8_t *data, size_t length,
   size_t *totalLength, X509SubjectPublicKeyInfo *publicKeyInfo)
{
   error_tc error;
   Asn1Tag tag;
...
error_tc x509ParseRsaPublicKey(const uint8_t *data, size_t length,
...
error_tc x509ParseDsaPublicKey(const uint8_t *data, size_t length,
...
error_tc x509ParseDsaParameters(const uint8_t *data, size_t length,
...
error_tc x509ParseEcPublicKey(const uint8_t *data, size_t length,
...
error_tc x509ParseEcParameters(const uint8_t *data, size_t length,
...
error_tc x509ImportRsaPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
error_tc x509ImportDsaPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
error_tc x509ImportEcPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
error_tc x509ImportEcParameters(const X509EcParameters *ecParams,
   EcDomainParameters *params)
{
   error_tc error;
...
error_tc x509ImportEddsaPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
