...
error_tc kemGenerateKeyPair(KemContext *context, const PrngAlgo *prngAlgo,
   void *prngContext);

error_tc kemLoadPublicKey(KemContext *context, const uint8_t *pk);

error_tc kemEncapsulate(KemContext *context, const PrngAlgo *prngAlgo,
   void *prngContext, uint8_t *ct, uint8_t *ss);

error_tc kemDecapsulate(KemContext *context, const uint8_t *ct, uint8_t *ss);
