...
error_tc mlkem1024GenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc mlkem1024Encapsulate(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc mlkem1024Decapsulate(uint8_t *ss, const uint8_t *ct, const uint8_t *sk)
{
   OQS_STATUS status;
