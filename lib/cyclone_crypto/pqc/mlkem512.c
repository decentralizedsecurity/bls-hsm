...
error_tc mlkem512GenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc mlkem512Encapsulate(const PrngAlgo *prngAlgo, void *prngContext,
...
error_tc mlkem512Decapsulate(uint8_t *ss, const uint8_t *ct, const uint8_t *sk)
{
   OQS_STATUS status;
