...
error_tc yarrowInit(YarrowContext *context)
{
   //Clear PRNG state
...
error_tc yarrowSeed(YarrowContext *context, const uint8_t *input, size_t length)
{
   //Check parameters
...
error_tc yarrowAddEntropy(YarrowContext *context, uint_t source,
...
error_tc yarrowRead(YarrowContext *context, uint8_t *output, size_t length)
{
   size_t n;
