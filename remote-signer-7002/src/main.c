...
static int __wifi_args_to_params(struct wifi_connect_req_params *params)
{
	...
	params->psk = "V97iGDiampVpB27Vt5VF";
...
void main(void)
{
	...
	error_tc ret = scrypt(pass, salt, 32, 128, 8, 1, dk, 32);
	int64_t elapsedsc = k_uptime_delta(&ref);
	if(ret == 0){
