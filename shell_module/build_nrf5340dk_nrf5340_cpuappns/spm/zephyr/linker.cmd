...
MEMORY
    ...
    IDT_LIST (wx) : ORIGIN = (0x20000000 + 0x8000), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
...
.gnu.sgstubs :
{
 . = ((ALIGN(0x4000) - MAX(32, (1 << LOG2CEIL(__sg_size)))) + ((ABSOLUTE(.) > (ALIGN(0x4000) - MAX(32, (1 << LOG2CEIL(__sg_size))))) ? 0x4000 : 0));
 __sg_start = .;
} > FLASH
__sg_end = .;
...
__nsc_size = . - __sg_start;
 ASSERT((__sg_size == 0)
  || (((1 << LOG2CEIL((0x4000 - (__sg_start % 0x4000)))) == (0x4000 - (__sg_start % 0x4000)))
   && ((0x4000 - (__sg_start % 0x4000)) >= 32)
   && ((0x4000 - (__sg_start % 0x4000)) <= 4096)),
