...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_FOREGROUND_CMDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_DYNAMIC_CMDS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 49152);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPM_BUILD_STRATEGY_SKIP_BUILD, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_IMAGE_NOT_BUILT_FROM_SOURCE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_STACK_SIZE, 49152);
